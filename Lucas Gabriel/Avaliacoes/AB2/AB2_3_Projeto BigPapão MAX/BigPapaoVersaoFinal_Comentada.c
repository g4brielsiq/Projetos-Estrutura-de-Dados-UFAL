...
void despachar_tarefas(Cozinha *c)
{
    ...
    // Habilidade habilidades[] = {HABILIDADE_MONTAGEM, HABILIDADE_BEBIDAS, HABILIDADE_BATATA, HABILIDADE_SANDUICHE};
    // Equipamento *equipamentos[] = {NULL, &c->liquidificador, &c->fritadeira, &c->chapa};
